...
func GenerateKeys() (modulusBytes string, privateExponentBytes string, privateKey *rsa.PrivateKey, publicKey rsa.PublicKey) {
...
func Decrypt(encryptedBytes []byte, privateKey *rsa.PrivateKey, publicKey rsa.PublicKey) (decryptString string) {
...
func main() {
	_, _, privateKey, publicKey := GenerateKeys()
	...
	Decrypt(encryptedBytes, privateKey, publicKey)
}
